...
ROAD_SEGMENTS = [
    ...
    {
        "id": "vlc-a3",
        "name": "Valencia A-3 — Autovía de Este",
        "road_class": "motorway",
        "length_m": 3200.0,
        "speed_limit_kmh": 100,
        "lanes": 3,
        "geom_wkt": "LINESTRING(-0.4100 39.4650, -0.3500 39.4700)",
    },
    {
        "id": "vlc-v30",
        "name": "Valencia V-30 — Ronda Interior Norte",
        "road_class": "motorway",
        "length_m": 2800.0,
        "speed_limit_kmh": 80,
        "lanes": 3,
        "geom_wkt": "LINESTRING(-0.3900 39.4900, -0.3600 39.4750)",
    },
    {
        "id": "vlc-av-port",
        "name": "Valencia — Avinguda del Port",
        "road_class": "primary",
        "length_m": 1500.0,
        "speed_limit_kmh": 50,
        "lanes": 2,
        "geom_wkt": "LINESTRING(-0.3350 39.4650, -0.3250 39.4550)",
    },
    {
        "id": "vlc-blasco-ibanez",
        "name": "Valencia — Avinguda de Blasco Ibáñez",
        "road_class": "primary",
        "length_m": 1800.0,
        "speed_limit_kmh": 50,
        "lanes": 2,
        "geom_wkt": "LINESTRING(-0.3700 39.4780, -0.3500 39.4800)",
    },
    # ── Barcelona ────────────────────────────────────────────────────────────
    {
        "id": "bcn-ap7",
        "name": "Barcelona AP-7 — Ronda Litoral",
        "road_class": "motorway",
        "length_m": 4100.0,
        "speed_limit_kmh": 100,
        "lanes": 3,
        "geom_wkt": "LINESTRING(2.1500 41.3700, 2.2000 41.3900)",
    },
    {
        "id": "bcn-b23",
        "name": "Barcelona B-23 — Eixample / Les Corts",
        "road_class": "motorway",
        "length_m": 2600.0,
        "speed_limit_kmh": 80,
        "lanes": 3,
        "geom_wkt": "LINESTRING(2.1200 41.3750, 2.1500 41.3820)",
    },
    {
        "id": "bcn-diagonal",
        "name": "Barcelona — Avinguda Diagonal",
        "road_class": "primary",
        "length_m": 3500.0,
        "speed_limit_kmh": 50,
        "lanes": 3,
        "geom_wkt": "LINESTRING(2.1050 41.3870, 2.1800 41.3960)",
    },
    {
        "id": "bcn-gran-via",
        "name": "Barcelona — Gran Via de les Corts Catalanes",
        "road_class": "primary",
        "length_m": 2900.0,
        "speed_limit_kmh": 50,
        "lanes": 2,
        "geom_wkt": "LINESTRING(2.1100 41.3790, 2.1850 41.3800)",
    },
]
